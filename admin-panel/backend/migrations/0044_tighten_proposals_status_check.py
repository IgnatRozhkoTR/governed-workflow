"""Tighten the proposals.status CHECK constraint.

'pending' and 'approved' are never written by any code path; the lifecycle
starts at 'proposed' and ends at 'rejected', 'executed', or 'failed'. Removes
...
step("""
    CREATE TABLE proposals_new (
        ...
        status TEXT NOT NULL DEFAULT 'proposed' CHECK (status IN (
            'proposed','rejected','executed','failed'
        )),
        title TEXT NOT NULL,
